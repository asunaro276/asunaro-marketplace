...
JSONの `recommended_question_count` に基づいて質問数を決定する：
...
推奨質問数をまとめて提示し、ユーザーの回答を待つ。

#### 4-4. 継続確認

推奨質問数の回答後、「振り返りを続けますか？」とユーザーに確認する。

- **続ける** → 更に1〜2問追加して回答を待つ。再度継続確認を行う。
- **終了** → ステップ5に進む。
